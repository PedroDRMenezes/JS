...
function IDN(){
    var tarefa =  document.getElementById("IDF").value;
    var tudo = "<div class='itemTarefa' draggable='true' ondragstart='pegaItem(event);' id='t"+ I +"'>"+ tarefa +"</div>"
    document.getElementById("pendentes").innerHTML += tudo;
    I++
}